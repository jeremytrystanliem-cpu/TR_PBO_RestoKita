...
public class MenuController {
    ...
    // 1. Setup Tabel Visual (Untuk View Admin)
    ...
    // 3. Tambah Menu (Insert)
    public boolean insertMenu(String nama, double harga, int stok, String kategori) {
        try {
            // Perhatikan tanda kutip satu (') untuk tipe data String
            this.sql = "INSERT INTO menus (nama_menu, harga, stok, kategori) VALUES " +
    ...
    // 4. Update Menu
    public boolean updateMenu(int id, String nama, double harga, int stok, String kategori) {
        try {
