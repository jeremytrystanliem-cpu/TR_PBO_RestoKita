...
public class Admin extends javax.swing.JFrame {
    ...
    // --- METHOD HELPER UNTUK HALAMAN ADMIN ---
    
    private void loadData() {
        MenuController mc = new MenuController();
        DefaultTableModel model = mc.createTable(); // Ambil struktur tabel
        mc.dtm = model; 
        mc.tampilkanMenu(); // Isi data dari DB
        tabelMenu.setModel(mc.dtm); // Pasang ke Tabel View
    }
    ...
    private void clearForm() {
        ...
        btnSimpan.setEnabled(true); // Aktifkan lagi tombol simpan
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(txtID, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 140, 250, 35));
    ...
    private void btnUbahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUbahActionPerformed
        try {
            ...
            MenuController mc = new MenuController();
            boolean sukses = mc.updateMenu(id, nama, harga, stok, kat, txtGambar.getText());
    ...
    private void tabelMenuMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelMenuMouseClicked
        ...
        if (baris != -1) {
            txtID.setText(tabelMenu.getValueAt(baris, 0).toString());
            ...
            // Cek Gambar (cegah error jika null)
            Object img = tabelMenu.getValueAt(baris, 5);
            txtGambar.setText(img != null ? img.toString() : "");
            
            btnSimpan.setEnabled(false); // Matikan simpan agar tidak duplikat
        }
